...
parser.add_argument(
    ...
    type=float,
    default=80,
    help="Remove SNPs with chi2 > this value (if it" "s larger than 0.001*N)",
)
...
parser.add_argument(
    "--anno", default=None, help="comma-separated list of annotations to use"
)
...
parser.add_argument(
    "--ridge_lambda",
    default=None,
    help="Lambda value for ridge (selected automatically if not set)",
)
