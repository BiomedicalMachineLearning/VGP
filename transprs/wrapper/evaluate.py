...
def Inner_evaluate(processor, methods, metric, trait_col, prs_col, use_pca=True, validate=False):
    for method in methods:
        ...
        if metric == "r2_score":
            tprs.metrics.r2_score_evaluation(
                processor, method=method, trait_col=trait_col, prs_col=prs_col, use_pca=use_pca, validate=validate
            )
