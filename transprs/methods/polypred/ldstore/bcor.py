...
class bcor:
    ...
    def __getIndex(self, snp_x, snp_y):
        if snp_x > snp_y:
            return (
                0.5 * self.__nSNPs * (self.__nSNPs - 1.0)
                - 0.5 * (self.__nSNPs - snp_y) * ((self.__nSNPs - snp_y) - 1.0)
                + snp_x
                - snp_y
                - 1.0
            )
            ...
            return (
                0.5 * self.__nSNPs * (self.__nSNPs - 1.0)
                - 0.5 * (self.__nSNPs - snp_x) * ((self.__nSNPs - snp_x) - 1.0)
                + snp_y
                - snp_x
                - 1.0
            )
